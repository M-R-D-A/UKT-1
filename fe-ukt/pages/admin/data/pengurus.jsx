                ...
                <div className="grid grid-cols-2 gap-x-5">
                            ...
                            return (
                                <Link href={'./pengurus_cabang'} className="bg-navy hover:bg-gradient-to-r from-[#16D4FC] to-[#9A4BE9] rounded-md p-0.5">
                                    ...
                                    <div className="bg-navy p-5 rounded-md space-y-5">
                                        ...
                                        <h1 className='text-white text-4xl font-semibold tracking-wider'>{dataPengurus.filter(a => a.id_role === 'pengurus cabang').length}</h1>
                                    </div>
                                </Link>
                            )
                    ...
                    <Link href={'./pengurus_ranting'} className="bg-navy hover:bg-gradient-to-r from-[#16D4FC] to-[#9A4BE9] rounded-md p-0.5">
                        ...
                        <div className="bg-navy p-5 rounded-md space-y-5">
                            ...
                            {/* data count and button add data */}
                            <h1 className='text-white text-4xl font-semibold tracking-wider'>{dataPengurus.filter(a => a.id_role === 'pengurus ranting').length}</h1>
                        </div>
                    </Link>
                </div>
            </BasicLayout>
