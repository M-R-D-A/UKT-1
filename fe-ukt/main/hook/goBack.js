...
export const GoBackPreviousPage = () => {
...
export const GoBackPreviousPageButton = () => {
    const router = useRouter();
    ...
    return (
        <button onClick={goBack} className="bg-purple hover:bg-white rounded-md w-9 h-9 flex justify-center items-center group duration-300">
